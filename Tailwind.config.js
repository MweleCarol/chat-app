    ...
    extend: {
      ...
      colors: {
        ...
        accent: {
          DEFAULT: "#7c6dfa",
          2:       "#fa6d9a",
          dim:     "rgba(124,109,250,0.18)",
          glow:    "rgba(124,109,250,0.30)",
        },
        border: {
      ...
      animation: {
        ...
        "bubble-in":    "bubbleIn 0.22s cubic-bezier(0.34,1.56,0.64,1)",
      ...
      keyframes: {
        pulseDot: {
          ...
          "50%":     { boxShadow: "0 0 18px #7c6dfa, 0 0 32px rgba(124,109,250,0.30)", transform: "scale(1.25)" },
        },
        rotateRing: {
      ...
      boxShadow: {
        glow:   "0 4px 16px rgba(124,109,250,0.30)",
        "glow-lg": "0 6px 24px rgba(124,109,250,0.40)",
